let usernameInput = document.form.username;
...
rePasswordInput.onchange = () => {
    ...
    document.querySelector('.error-password-again').style.display = passwordsAreSame ? 'none' : 'block';
    document.querySelector('button').disabled = allInputsAreInvalid();
}

document.querySelector('.registration-send-button').addEventListener('click', () => {
    const user = {
